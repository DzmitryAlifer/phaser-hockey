...
export const POSITION_OFFENSIVE = new Map<Position, Geom.Rectangle>([
    ...
    [Position.LW, new Geom.Rectangle(BLUE_LINE_X_OFFSET + HALF_ZONE_OFFSET, -SIZE_Y / 2, HALF_ZONE_OFFSET, SIZE_Y / 2)],
    [Position.RW, new Geom.Rectangle(BLUE_LINE_X_OFFSET + HALF_ZONE_OFFSET, 0, HALF_ZONE_OFFSET, SIZE_Y / 2)],
