...
import { CORNER, SIZE_X, SIZE_Y, PUCK_SIZE } from '../constants';
...
export class Hockey extends Scene {
    ...
    create() {
        ...
        const boxInnerVerts = `${SIZE_X / 2 - 1} 10 ${CORNER + 10} 10 10 ${CORNER + 10} 10 ${SIZE_Y - 10} ${SIZE_X - 10} ${SIZE_Y - 10} ${SIZE_X - 10} 10 ${SIZE_X / 2} 10`;
